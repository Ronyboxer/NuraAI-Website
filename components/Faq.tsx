...
export default function Faq() {
  ...
  return (
    <section id="faq" className="bg-canvas py-32">
                ...
                <li key={item.q}>
                  <h3>
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-4 px-6 py-5 text-left transition-colors hover:bg-tint"
                    >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="px-6 pb-6 pt-0 text-pretty leading-relaxed text-slate">
                          {item.a}
                        </p>
                      </motion.div>
                    )}
