...
export const answerDemo = [
  ...
  },
  {
    ...
    answer: "You live with your daughter Anne. You're safe at home.",
  },
];

export const problem = {
  heading: "When the questions never stop, love can wear thin.",
  body: '"Where\'s my daughter?" "Did I eat?" "What day is it?" — asked again and again, every hour. You answer with love the first time, and the tenth. By the fortieth, you\'re exhausted. And the AI everyone recommends just makes things up — the last thing a confused mind needs.',
};
...
export const features = {
  ...
  items: [
    {
      icon: "Mic",
      title: "Voice-first & effortless",
      body: "One button. Just speak. Nothing new to learn.",
    },
    {
      icon: "SlidersHorizontal",
      title: "All the work stays with you",
      body: "Every setting and answer lives on the caregiver side. Their side stays simple.",
    },
    {
      icon: "Infinity",
    ...
    {
      icon: "HandHeart",
      title: "Gentle, never corrective",
      body: "It validates and reassures instead of arguing with a confused moment.",
    },
    {
      icon: "ShieldCheck",
      title: "Private by design",
      body: "Your family's memories are yours. Kept secure, and never sold.",
    },
    {
      icon: "Eye",
      title: "Built for their world",
      body: "Calm, large, and clear, for older eyes and ears.",
    },
  ],
};
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Yes. Your family's memories belong to your family. They're kept secure and are never sold.",
    },
    {
